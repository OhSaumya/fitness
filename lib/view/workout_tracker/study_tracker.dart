...
class StudyTrackerView extends StatefulWidget {
  const StudyTrackerView({super.key});

  @override
  State<StudyTrackerView> createState() => _StudyTrackerViewState();
}

class _StudyTrackerViewState extends State<StudyTrackerView> {
  List latestArr = [
    {
      "image": "assets/img/study_1.jpg",
      "title": "Mathematics Study",
      "time": "Today, 03:00pm"
    },
    {
      "image": "assets/img/study_2.jpg",
      "title": "Physics Study",
